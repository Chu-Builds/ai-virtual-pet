...
export const ACCENT = '#F97316'           // teal — swap to your primary brand color

// Derived from ACCENT — adjust opacity as needed
export const ACCENT_DIM = 'rgba(249,115,22,0.12)'
export const ACCENT_BORDER = 'rgba(249,115,22,0.30)'
export const ACCENT_GLOW = 'rgba(249,115,22,0.20)'
// Text color on dark background using accent tone
export const ACCENT_LIGHT = '#FED7AA'
